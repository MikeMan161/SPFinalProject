...
def start_program():
    ...
    while True:
        stop_event = threading.Event()  # Create a fresh stop_event for each iteration
        ...
        # Prompt to restart or exit the program
        restart_choice = input("Would you like to restart the program? (yes/no): ").strip().lower()
